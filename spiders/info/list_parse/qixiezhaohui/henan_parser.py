...
class HeNanInfoParser(BaseParser):
    """
    河南省药品监督管理局  https://yjj.henan.gov.cn/ylqx/ylqxzh/
    """

    def start_requests(self):
        url = "https://yjj.henan.gov.cn/ylqx/ylqxzh/"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "https://yjj.henan.gov.cn/ylqx/ylqxzh/index_{}.html"

...
class GuangXiInfoParser(BaseParser):
    """
    广西省药品监督管理局  http://yjj.gxzf.gov.cn/ylqx/ylqxzh/
    """

    def start_requests(self):
        url = "http://yjj.gxzf.gov.cn/ylqx/ylqxzh/"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "http://yjj.gxzf.gov.cn/ylqx/ylqxzh/index_{}.shtml"

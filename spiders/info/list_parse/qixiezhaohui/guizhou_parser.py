...
class GuiZhouInfoParser(BaseParser):
    """
    贵州省药品监督管理局  http://yjj.guizhou.gov.cn/gsgg/cpzh/index.html
    """

    def start_requests(self):
        url = "http://yjj.guizhou.gov.cn/gsgg/cpzh/index.html"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "http://yjj.guizhou.gov.cn/gsgg/cpzh/index_{}.html"

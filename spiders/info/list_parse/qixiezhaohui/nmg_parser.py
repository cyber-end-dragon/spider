...
class NmgInfoParser(BaseParser):
    ...
    def start_requests(self):
        url = "http://mpa.nmg.gov.cn/zfxxgkzl/fdzdgknr/jdjc_16819/zhxx_16822/"
    ...
    def parse_for_page(self, request, response):
        ...
        for i in range(1, page_num):
            ...
            page_url = "http://mpa.nmg.gov.cn/zfxxgkzl/fdzdgknr/jdjc_16819/zhxx_16822/index_%d.html" % i
            # print(page_url)

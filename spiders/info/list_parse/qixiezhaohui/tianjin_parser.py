...
class TianJinInfoParser(BaseParser):
    """
    天津市药品监督管理局  https://scjg.tj.gov.cn/tjsscjdglwyh_52651/tjyj/XWDT149660/TG149685/
    """
    def start_requests(self):
        url = "https://scjg.tj.gov.cn/tjsscjdglwyh_52651/tjyj/XWDT149660/TG149685/"
    ...
    def parse_for_page(self, request, response):
        ...
        for i in range(1, page_num):
            ...
            page_url = "https://scjg.tj.gov.cn/tjsscjdglwyh_52651/tjyj/XWDT149660/TG149685/index_%s.html" % i
            yield feapder.Request(url=page_url, callback=self.parse)
        
        
    def parse(self, request, response):

        source = "器械召回.天津市药品监督管理局"
        save_count = 0

...
class ChongQingInfoParser(BaseParser):
    """
    重庆市药品监督管理局  http://yaojianju.cq.gov.cn/zwgk_217/fdzdgknr/jdjc/jdjcylqx/ylqxzh/
    """

    def start_requests(self):
        url = "http://yaojianju.cq.gov.cn/zwgk_217/fdzdgknr/jdjc/jdjcylqx/ylqxzh/"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "http://yaojianju.cq.gov.cn/zwgk_217/fdzdgknr/jdjc/jdjcylqx/ylqxzh/index_{}.html"

...
class ZheJiangInfoParser(BaseParser):
    """
    浙江省药品监督管理局  http://mpa.zj.gov.cn/col/col1228972407/index.html
    """

    def start_requests(self):
        url = "http://mpa.zj.gov.cn/col/col1228972407/index.html"
    ...
    def parse_for_page(self, request, response):
        ...
        headers = {
            ...
            'Referer': 'http://mpa.zj.gov.cn/col/col1228972407/index.html',
        }
        from_data = {
            "col": "1",
            "appid": "1",

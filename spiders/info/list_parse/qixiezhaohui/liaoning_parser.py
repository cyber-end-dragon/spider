...
class LiaoNingInfoParser(BaseParser):
    """
    辽宁省药品监督管理局  https://ypjg.ln.gov.cn/ypjg/ztzl/cpzh/index.shtml
    """

    def start_requests(self):
        url = "https://ypjg.ln.gov.cn/ypjg/ztzl/cpzh/index.shtml"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "https://ypjg.ln.gov.cn/ypjg/ztzl/cpzh/8ef951a8-{}.shtml"
        # page_num = 1

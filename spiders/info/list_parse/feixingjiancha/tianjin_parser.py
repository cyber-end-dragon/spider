...
class TianJinInfoParser(BaseParser):
    """
    天津市药品监督管理局  https://scjg.tj.gov.cn/tjsscjdglwyh_52651/tjyj/XWDT149660/TG149685/index.html
    """
    def start_requests(self):
        url = "https://scjg.tj.gov.cn/tjsscjdglwyh_52651/tjyj/XWDT149660/TG149685/index.html"
    ...
    def parse_for_page(self, request, response):
        ...
        for i in range(1, page_num):
            ...
            page_url = "https://scjg.tj.gov.cn/tjsscjdglwyh_52651/tjyj/XWDT149660/TG149685/index_%d.html" % i
            yield feapder.Request(url=page_url, callback=self.parse)
        
        
    def parse(self, request, response):

        source = "飞行检查.天津市药品监督管理局"
        save_count = 0
        filter_word1 = ["医疗器械", "飞行检查"]
        filter_word2 = ["公司", "厂", "飞行检查"]
        title_contents = response.xpath("//ul[@class='news_list']/li")
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_tianjin", delete_keys=True)
    spider.add_parser(TianJinInfoParser)

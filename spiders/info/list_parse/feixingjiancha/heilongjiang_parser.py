...
class HeiLongJiangInfoParser(BaseParser):
    """
    黑龙江省药品监督管理局  http://mpa.hlj.gov.cn/mpa/c113665/list.shtml
    """

    def start_requests(self):
        url = "http://mpa.hlj.gov.cn/mpa/c113665/list.shtml"
    ...
    def parse(self, request, response):
        ...
        source = "飞行检查.黑龙江省药品监督管理局"
        save_count = 0
        filter_word1 = ["医疗器械", "飞行检查"]
        filter_word2 = ["公司", "厂", "飞行检查"]
        title_contents = response.xpath("//ul[@class='listul']//li")

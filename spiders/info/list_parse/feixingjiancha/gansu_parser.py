...
class GanSuInfoParser(BaseParser):
    """
    甘肃省药品监督管理局  http://yjj.gansu.gov.cn/yjj/c114335/jgxx_list.shtml
    """
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_GanSuInfoParser", delete_keys=True)
    spider.add_parser(GanSuInfoParser)

...
class AnHuiInfoParser(BaseParser):
    """
    安徽省药品监督管理局  https://mpa.ah.gov.cn/public/column/4140867?type=4&action=list&nav=&sub=&catId=10836628
    """

    def start_requests(self):
        url = "https://mpa.ah.gov.cn/public/column/4140867?type=4&action=list&nav=&sub=&catId=10836628"
        ...
        for title_content in title_contents:
            ...
            if not condj[0]:
                if not condj[1]:
                    ...
                    file_urls = resp.xpath("//a[@data-file-ext]/@href") or resp.xpath("//a[text()='点击下载']/@href")
                    result = []

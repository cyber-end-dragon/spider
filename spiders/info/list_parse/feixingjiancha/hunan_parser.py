...
class HuNanInfoParser(BaseParser):
    """
    湖南省药品监督管理局  http://mpa.hunan.gov.cn/mpa/ylqx/xxgk_new.html
    """

    def start_requests(self):
        url = "http://mpa.hunan.gov.cn/mpa/ylqx/xxgk_new.html"
    ...
    def parse(self, request, response):
        ...
        source = "飞行检查.湖南省药品监督管理局"
        save_count = 0

        title_contents = response.xpath("//ul[@class='con_1']/li")

...
class GuiZhouInfoParser(BaseParser):
    """
    贵州省药品监督管理局  http://yjj.guizhou.gov.cn/gsgg/zlcjggtg/ylqxzlgg1/
    """

    def start_requests(self):
        url = "http://yjj.guizhou.gov.cn/gsgg/zlcjggtg/ylqxzlgg1/"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "http://yjj.guizhou.gov.cn/gsgg/zlcjggtg/ylqxzlgg1/index_{}.html"
    ...
    def parse(self, request, response):
        ...
        source = "飞行检查.贵州省药品监督管理局"
        save_count = 0
        filter_word1 = ["医疗器械", "飞行检查"]
        title_contents = response.xpath("//div[@class='right-list-box']//li")
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_GuiZhouInfoParser", delete_keys=True)
    spider.add_parser(GuiZhouInfoParser)

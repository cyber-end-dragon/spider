...
class JiangSu2InfoParser(BaseParser):
    """
    江苏省药品监督管理局  http://da.jiangsu.gov.cn/col/col84605/index.html
    """

    def start_requests(self):
        url = "http://da.jiangsu.gov.cn/col/col84605/index.html"
    ...
    def parse_for_page(self, request, response):
        ...
        headers = {
            ...
            'Referer': 'http://da.jiangsu.gov.cn/col/col84605/index.html?uid=374127&pageNum=1',
        }
        from_data = {
            "col": "15",
            "appid": "1",
    ...
    def parse(self, request, response):
        ...
        for title_content in title_contents[:45]:
            ...
            try:
                title = re.findall(r">·(.*?)</a>", title_content)[0]
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_JiangSu2InfoParser", delete_keys=True)
    spider.add_parser(JiangSu2InfoParser)

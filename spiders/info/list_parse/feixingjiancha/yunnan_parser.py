...
class YunNanInfoParser(BaseParser):
    """
    云南省药品监督管理局  http://mpa.yn.gov.cn/newsite/ZwgkNewsList.aspx?CID=673bddbb-0680-4613-8815-16617142e827
    """

    def start_requests(self):
        url = "http://mpa.yn.gov.cn/newsite/ZwgkNewsList.aspx?CID=673bddbb-0680-4613-8815-16617142e827"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "http://mpa.yn.gov.cn/newsite/ZwgkNewsList.aspx?CID=673bddbb-0680-4613-8815-16617142e827&page={}"
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_YunNanInfoParser", delete_keys=True)
    spider.add_parser(YunNanInfoParser)

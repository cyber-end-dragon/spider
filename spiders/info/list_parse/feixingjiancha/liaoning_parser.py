...
class LiaoNingInfoParser(BaseParser):
    """
    辽宁省药品监督管理局  https://ypjg.ln.gov.cn/ypjg/zwfw/ggtg/ylqx/index.shtml
    """

    def start_requests(self):
        url = "https://ypjg.ln.gov.cn/ypjg/zwfw/ggtg/ylqx/index.shtml"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "https://ypjg.ln.gov.cn/ypjg/zwfw/ggtg/ylqx/4e67df35-{}.shtml"
        # page_num = 1
    ...
    def parse(self, request, response):
        ...
        source = "飞行检查.辽宁省药品监督管理局"
        save_count = 0
        filter_word = ["医疗器械", "飞行检查"]
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_LiaoNingInfoParser", delete_keys=True)
    spider.add_parser(LiaoNingInfoParser)

...
class GuangXiInfoParser(BaseParser):
    """
    广西省药品监督管理局  http://yjj.gxzf.gov.cn/ylqx/ylqxjdjc/
    """

    def start_requests(self):
        url = "http://yjj.gxzf.gov.cn/ylqx/ylqxjdjc/"
    ...
    def parse_for_page(self, request, response):
        ...
        base_url = "http://yjj.gxzf.gov.cn/ylqx/ylqxjdjc/index_{}.shtml"
    ...
    def parse(self, request, response):
        ...
        source = "飞行检查.广西省药品监督管理局"
        save_count = 0
        filter_word1 = ["医疗器械", "飞行检查"]
        filter_word2 = ["公司", "厂", "飞行检查"]
        title_contents = response.xpath("//div[@id='morelist']//li")
...
if __name__ == "__main__":
    ...
    spider = tmp(redis_key="test_GuangXiInfoParser", delete_keys=True)
    spider.add_parser(GuangXiInfoParser)

...
REDISDB_IP_PORTS = "xxx.xxx.x.xx:xxxxx"
# REDISDB_USER_PASS = ""
REDISDB_DB = 0
# # 适用于redis哨兵模式
...
#     # proxy="127.0.0.1:7890",  # xxx.xxx.xxx.xxx:xxxx 或 无参函数，返回值为代理地址
...
#
# # 设置代理
# PROXY_EXTRACT_API = "http://hadoop2:8090"  # 代理提取API ，返回的代理分割符为\r\n
# PROXY_ENABLE = True
#
# # 随机headers
RANDOM_HEADERS = True
...
CUSTOM_TUNNEL = "xxx.xxx.x.xx:xxxxx"
CUSTOM_PROXY = {
    "http": f"http://{CUSTOM_TUNNEL}", 
    "https": f"http://{CUSTOM_TUNNEL}"
} 
